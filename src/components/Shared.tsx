...
interface AppStateContextType {
  ...
  authView: 'login' | 'signup' | 'otp' | 'business_register';
  setAuthView: (v: 'login' | 'signup' | 'otp' | 'business_register') => void;
...
export function AppStateProvider({ children }: { children: React.ReactNode }) {
  ...
  const [authView, setAuthView] = useState<'login' | 'signup' | 'otp' | 'business_register'>('login');
